classdef AR2 < arduinoio.LibraryBase
    ...
    methods(Hidden, Access = public)
        function obj = AR2(parentObj)
            ...
            obj.Stepper(1) = arduinoioaddons.AR2.AR2Stepper(obj,[2,3],obj.STEPPER_CONSTANT(1));
            obj.Stepper(2) = arduinoioaddons.AR2.AR2Stepper(obj,[3,4],obj.STEPPER_CONSTANT(2));
            obj.Stepper(3) = arduinoioaddons.AR2.AR2Stepper(obj,[6,7],obj.STEPPER_CONSTANT(3));
            obj.Stepper(4) = arduinoioaddons.AR2.AR2Stepper(obj,[8,9],obj.STEPPER_CONSTANT(4));
            obj.Stepper(5) = arduinoioaddons.AR2.AR2Stepper(obj,[10,11],obj.STEPPER_CONSTANT(5));
            obj.Stepper(6) = arduinoioaddons.AR2.AR2Stepper(obj,[12,13],obj.STEPPER_CONSTANT(6));
